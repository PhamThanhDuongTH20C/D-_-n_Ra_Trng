...
class _AddProoductState extends State<AddProoduct> {
  ...
  Future postData() async {
    ...
    if (tensp.text.characters.isEmpty ||
        gia.text.characters.isEmpty ||
        mota.text.characters.isEmpty ||
        int.tryParse(gia.text)! < 0 ||
        _image == null) {
      ScaffoldMessenger.of(context)
          .showSnackBar(const SnackBar(content: Text('Hãy điền vào các ô')));
    }
  }
}
